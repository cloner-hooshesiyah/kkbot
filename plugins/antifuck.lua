...
local msgs = 
{
    already_locked = "ØªÙ… Ø¨Ø§Ù„ÙØ¹Ù„ ØªÙØ¹ÙŠÙ„ Ù…Ø¶Ø§Ø¯ Ø§Ù„ÙƒÙ„Ù…Ø§Øª Ø§Ù„Ø³ÙŠØ¦Ø©", -- the message that sent when you try to lock the fuck and it's already locked
    Locked = "ØªÙ… ØªÙØ¹ÙŠÙ„ Ù…Ø¶Ø§Ø¯ Ø§Ù„ÙƒÙ„Ù…Ø§Øª Ø§Ù„Ø³ÙŠØ¦Ø©, ÙŠØ±Ø¬Ù‰ Ù…Ù† Ø§Ù„Ø§Ø¹Ø¶Ø§Ø¡ Ø¹Ø¯Ù… Ø§Ù„ØªÙƒÙ„Ù… Ø¨ÙƒÙ„Ù…Ø§Øª Ø³ÙŠØ¦Ø© ÙˆØ§Ù„ÙØ§Ø¸ Ù…Ø®Ù„Ø© Ø¨Ø§Ù„Ø§Ø¯Ø¨", -- the message that send when you lock the fuck

    already_unlocked = "ØªÙ… Ø¨Ø§Ù„ÙØ¹Ù„ Ø§ÙŠÙ‚Ø§Ù ØªÙØ¹ÙŠÙ„ Ù…Ø¶Ø§Ø¯ Ø§Ù„ÙƒÙ„Ù…Ø§Øª Ø§Ù„Ø³ÙŠØ¦Ø©", -- the message that sent when you try to unlock the fuck and it's already unlocked
    UnLocked = "ØªÙ… Ø§Ù„ØºØ§Ø¡ ØªÙØ¹ÙŠÙ„ Ù…Ø¶Ø§Ø¯ Ø§Ù„ÙƒÙ„Ù…Ø§Øª Ø§Ù„Ø³ÙŠØ¦Ø©, ÙŠÙ…ÙƒÙ†Ùƒ Ù‚ÙˆÙ„ Ù…Ø§ØªØ´Ø§Ø¡ ðŸ˜’ðŸ™ŒðŸ¿", -- the message that send when you unlock the fuck
